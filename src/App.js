      ...
      <div className="frame">
        ...
        <div className="body">
          <div className="about">
            ...
            <p>Hey! I am Aman Kumar and I am pursuing my B.Tech Degree from VIT in ECE. I love to code and learn new things related to computer.</p>
          </div>
